ALTER TYPE "public"."daget_status" ADD VALUE 'drawing';--> statement-breakpoint
ALTER TYPE "public"."daget_type" ADD VALUE 'raffle';--> statement-breakpoint
ALTER TYPE "public"."notification_type" ADD VALUE 'raffle_won';--> statement-breakpoint
ALTER TYPE "public"."notification_type" ADD VALUE 'raffle_lost';--> statement-breakpoint
ALTER TYPE "public"."notification_type" ADD VALUE 'raffle_drawn';--> statement-breakpoint
